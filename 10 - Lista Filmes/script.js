...
//Cria um array de filmes favoritos
let filmesFavoritos = [];

//pega o elemento button e a lista de filmes
...
function removeFromLocalStorage(id) {
  ...
  const filmesFiltrados = filmesFavoritos.filter(
    (movie) => movie.id != procurarFilme.id
  );
  //transforma o array em string para poder salvar no LocalStorage
